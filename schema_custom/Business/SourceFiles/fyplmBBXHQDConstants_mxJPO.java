...
public class fyplmBBXHQDConstants_mxJPO {
	public static final String STRING_DATE_TIME_FORMATE = "MM/dd/yyyy hh:mm:ss a";
	public static final String DATE_FORMATE = "yyyy-MM-dd";
	public static final String TYPE_FYPLM_BBXHQD = "FYPLM BBXHQD";
